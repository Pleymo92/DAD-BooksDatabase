...
public class manageBooks {
    ...
    public void newUser(Book book) throws SQLException{
    ...
    public void deleteUser(Book book) throws SQLException{
    ...
    public void fillTableQuerry(String querry){
        try {
            if(isNumeric(querry)){
                ...
                clConnect.execQuerry("SELECT * from libros where titulo like '%" + querry
    ...
    private boolean isNumeric(String querry){
        try {
            Integer.parseInt(querry);
            return true;
