...
public class eventClass implements ActionListener, MouseListener, DocumentListener{
    ...
    public void refreshTable(){
        ...
        frm.getBooksTable().setModel(new tableView(manage.getResult()));
    }
    ...
    public void mouseClicked(MouseEvent mosEvent) {
        try {
            int row = frm.getBooksTable().getSelectedRow();
            String code = String.valueOf(frm.getBooksTable().getValueAt(row, 0));            
            //
